// Package render converts source documents (markdown / gemtext) to the two
// output formats the server speaks: HTML for the web, gemtext for gemini.
package render
...
// MarkdownToHTML renders markdown to an HTML fragment.
